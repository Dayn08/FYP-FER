...
📷 Real-time facial image capture using Raspberry Pi 4

🌐 Motion streaming to a Flask web server

🤖 Emotion detection and classification

📊 Web dashboard displaying analyzed emotional data

🧪 Functionality testing to validate system reliability

⚠️ Challenges

Memory limitations during model training (image dataset constraints)

Initial setup complexity of Raspberry Pi 4 and camera module

🚀 Impact

This project demonstrates the practical integration of embedded systems and AI-driven facial expression recognition to enhance classroom engagement. It highlights how technology can support educators in making data-driven teaching improvements.
